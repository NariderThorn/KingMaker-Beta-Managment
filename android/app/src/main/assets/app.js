...
function renderOverview(){
  ...
  document.getElementById('tab-overview').innerHTML = `
    ...
    <div class="card">
      <h3>Backup</h3>
      <div class="hint" style="margin-top:0;">Your kingdom is saved on this device only. Export a file to back it up or move it to another browser or app — import that file there to pick up right where you left off.</div>
